...
rename "install.asm" "header.asm" >NUL
rename "install.inc" "config.inc" >NUL
...
del default.xbe
rename out.xbe install.xbe >NUL


:: Move XBE to its own folder.
md "install" >NUL
move "*.xbe" "install" >NUL


:: Rename all ASM files back.
rename "config.inc" "install.inc" >NUL
rename "header.asm" "install.asm" >NUL
