...
::rename "NoVC Disc.asm" "header.asm" >NUL
rename "NoVC Disc.inc" "config.inc" >NUL
...
md "NoVC Disc" >NUL
move "*.xbe" "NoVC Disc" >NUL


:: Rename all ASM files back.
rename "config.inc" "NoVC Disc.inc" >NUL
::rename "header.asm" "NoVC Disc.asm" >NUL
