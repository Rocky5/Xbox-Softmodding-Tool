...
public:
	...
	// To enable say 480p and 720p you add the values together, A
	enum VIDEO_FLAGS
	{
		VIDEO_480I	= 0x00,
		VIDEO_480P	= 0x08,
	...
	BOOL			DWriteToBINFile(LPCSTR FileName);
...
//very XBOX specific funtions to read/write EEPROM from hardware
	...
	void			SetTimeZoneDltDateString(LPCSTR TimeZoneDltDate);
	void			SetTimeZoneDltBiasString(LPCSTR TimeZoneDltBias);
	void			SetNullChecksum3String(LPCSTR Checksum3);
